...
public class BloodSoldierMutation extends Mutation {
    ...
    public void activateAbility1(Player player) {
        ...
        world.spawnParticle(Particle.DUST, new Particle.DustOptions(Color.fromRGB(180,0,0), 1.5f), player.getLocation().add(0,1,0), 20, 0.5, 0.8, 0.5, 0);
