...
public class BypassMutation extends Mutation {
    ...
    public void onAssign(Player player) {
        ...
        player.sendMessage("§7Passive: Phase Defense (5% chance to ignore/reduce damage/knockback)");
    }
    ...
    public void activateAbility3(Player player) {
        ...
        plugin.getAdvancementManager().onDamagingAbilityUsed(player, "bypass_a3");
        ...
        plugin.getServer().getScheduler().runTaskTimer(plugin, task -> {
            ...
            for (LivingEntity e : nearby) {
                ...
                AbilityUtils.trueDamage(e, 5, player, "§3" + e.getName() + " §7was pierced by §3" + player.getName() + "§7's Phantom Dash");
    ...
    public void onDamageReceived(Player player, EntityDamageByEntityEvent event) {
        // 5% chance to completely negate the hit
