...
public class MutationItemManager {
    ...
    public ItemStack createMutationItem(MutationType type) {
        ...
        // Give each orb a unique UUID in PDC so no two orbs are ever NBT-identical,
        // which prevents Minecraft from stacking them together.
        NamespacedKey uuidKey = new NamespacedKey(plugin, "orb_uuid");
