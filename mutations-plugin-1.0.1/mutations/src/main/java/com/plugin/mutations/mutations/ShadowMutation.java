...
public class ShadowMutation extends Mutation {
    ...
    public void onTick(Player player) {
        ...
        // Dark dust swirl — hints at general location to nearby players
    ...
    private void hideFromAll(Player player) {
        for (Player other : Bukkit.getOnlinePlayers()) {
            if (other != player) other.hidePlayer(plugin, player);
        }
    }

    private void showToAll(Player player) {
        for (Player other : Bukkit.getOnlinePlayers()) {
            if (other != player) other.showPlayer(plugin, player);
        }
    }
