...
public class ShadowMutation extends Mutation {
    ...
    // Saved armor when true invis is active
    ...
    public void onTick(Player player) {
        ...
        // Dark dust particles — visible to others so they know your general location
    ...
    // ── True invis: remove armor/offhand + invis potion ───────────────────────
    private void hideFromAll(Player player) {
        ...
        // Strong invis potion hides the body too
        player.addPotionEffect(new PotionEffect(
