...
public class PassiveListener implements Listener {
    ...
    /** Prevent mutation orbs from being destroyed in entity explosions (TNT, creeper, etc.). */
    @EventHandler(priority = EventPriority.HIGH, ignoreCancelled = true)
    public void onOrbExplode(org.bukkit.event.entity.EntityExplodeEvent event) {
