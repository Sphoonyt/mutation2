...
public class DebuffMutation extends Mutation {
    ...
    public void onConsumeRottenFlesh(Player player, PlayerItemConsumeEvent event) {
        // Always cancel vanilla consume — we handle it ourselves so hunger level never blocks it
        event.setCancelled(true);

        // Remove 1 rotten flesh from hand manually
        ...
        // Same stats as a regular golden apple:
        // +4 hunger, +9.6 saturation, Regeneration II 5s
        // Then Absorption II for 2 minutes (instead of golden apple's Absorption I)
        ...
        player.sendMessage("§5☠ Rotten flesh consumed — Regen II + Absorption II applied!");
    }
