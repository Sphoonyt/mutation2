...
public class DebuffMutation extends Mutation {
    ...
    public void onConsumeRottenFlesh(Player player, PlayerItemConsumeEvent event) {
        // Cancel the vanilla consume and handle manually so it always works regardless of hunger
        event.setCancelled(true);

        // Manually remove 1 rotten flesh from hand
        ...
        player.sendMessage("§5☠ Rotten flesh consumed — golden apple effect applied!");
    }
