...
public class DebuffMutation extends Mutation {
    ...
    public void onConsumeRottenFlesh(Player player) {
        // Remove 1 rotten flesh from hand
        ...
        // Identical to a regular golden apple except Absorption II instead of I:
        // +4 hunger, +9.6 saturation, Regeneration II 5s, Absorption II 2min
