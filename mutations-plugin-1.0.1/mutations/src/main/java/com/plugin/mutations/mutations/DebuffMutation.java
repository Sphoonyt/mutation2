...
public class DebuffMutation extends Mutation {
    ...
    public void activateAbility1(Player player) {
        ...
        plugin.getAdvancementManager().onDamagingAbilityUsed(player, "debuff_a1");
        ...
        for (LivingEntity e : nearby) {
            AbilityUtils.trueDamage(e, 5, player, "§5" + (e instanceof Player ep ? ep.getName() : e.getName()) + " §7was overwhelmed by §5" + player.getName() + "§7's Mass Debuff");
            ...
            e.addPotionEffect(new PotionEffect(PotionEffectType.NAUSEA,     100, 0)); // Nausea 5s
