...
public class DragonborneMutation extends Mutation {
    ...
    private void venomBurst(Player player) {
        ...
        for (LivingEntity e : nearby) {
            AbilityUtils.trueDamage(e, 2, player); // 2 hearts
        ...
        runLater(() -> {
            ...
            for (LivingEntity e : finalHit) {
                AbilityUtils.trueDamage(e, 5, player); // 5 hearts
    ...
    private void blazingEruption(Player player) {
        ...
        for (LivingEntity e : nearby) {
            AbilityUtils.trueDamage(e, 4, player); // 4 hearts
    ...
    private void ironcladSurge(Player player) {
        ...
        runLater(() -> {
            ...
            for (LivingEntity e : nearby) {
                AbilityUtils.trueDamage(e, 5, player); // 5 hearts (2.5 hearts = 5 hp)
            ...
            runLater(() -> {
                ...
                for (LivingEntity e : hit) {
                    if (punch < 2) {
                        ...
                        AbilityUtils.trueDamage(e, 2, player); // 2 hearts per tick
    ...
    private void armorConstruct(Player player) {
        ...
        runLater(() -> {
            ...
            for (LivingEntity e : hit) AbilityUtils.trueDamage(e, 2, player); // 2 hearts // 3 AOE
